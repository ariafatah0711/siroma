...
@section('content')
    <div class="mx-auto max-w-xl">
        <x-section-heading eyebrow="Login" title="Masuk ke SIROMA" description="Gunakan akun mahasiswa untuk daftar rekrutmen dan melihat status pendaftaran." class="text-center" />
